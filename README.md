...
Thiết kế dãy phố — ứng dụng **OpenGL 3.3** (C++17), menu **ImGui**: preset ngày/đêm/thời tiết + preset **Performance/Balanced/Quality**, **năm nút nhóm** (tổng quan / môi trường / ánh sáng / hậu kỳ / GPU-scene), thời gian trong ngày, sương mù và mưa. Hỗ trợ chụp màn hình bằng **F12** (lưu `.ppm`).
